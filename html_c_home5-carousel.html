...
<div class="homeproductlistscontainer" style="visibility: hidden">
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- start laminated padlock carousel -->
            
            <div id="lampadlocks" class="bannerX carouselX slide" style="display: none; -ms-touch-action: none;">
                <div class="leftHalf"></div>
                <div id="bannersX" class="carousel-inner"></div>
                <ol id="banners_navigationX" class="carousel-indicators"></ol>
                <div class="container">
                    <a class="left carousel-control" href="#homepagebanners" role="button" data-slide="prev">
                        <i class="fa fa-angle-left"></i>
                    </a>
             ...
             <!-- end laminated padlock carousel -->

        
        <%--javaboxer START static grid for laminated padlocks--%>
        <div class="row">
        ...
        <%--javaboxer END static grid for laminated padlocks--%>
